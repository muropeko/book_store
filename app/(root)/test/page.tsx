...
export default function ChatPage() {
  ...
  return (
    <div style={{ maxWidth: 500, margin: "20px auto", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ height: 300, overflowY: "auto", border: "1px solid #ccc", padding: 10, borderRadius: 8 }}>
        {messages.map((msg, i) => (
          <div key={i} style={{ marginBottom: 6, padding: 6, backgroundColor: "#f0f0f0", borderRadius: 6 }}>
      ...
      <div style={{ marginTop: 10, display: "flex", gap: 8 }}>
        ...
        />
        <button onClick={sendMessage} style={{ padding: "8px 16px", borderRadius: 6, backgroundColor: "#4caf50", color: "#fff" }}>
          ентер
        </button>
      </div>
    </div>
