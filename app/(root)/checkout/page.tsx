...
export default function CheckoutPage() {
    ...
    return (
        <Container className="bg-blue-300 flex flex-row justify-center gap-10 py-5 items-start">
            {/* LEFT: Shipping form */}
            <OrderSectionWrapper text="Адреса Доставки" className="inline-block bg-red-300 w-[40%] self-start">
